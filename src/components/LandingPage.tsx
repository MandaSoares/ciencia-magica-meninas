...
export const LandingPage = ({ onGetStarted, onLogin }: LandingPageProps) => {
  const stemAreas = [
    { icon: Atom, label: "Ciências", color: "from-purple-400 to-purple-600", bg: "bg-purple-100", emoji: "🔬" },
    { icon: Calculator, label: "Matemática", color: "from-pink-400 to-pink-600", bg: "bg-pink-100", emoji: "📐" },
  ...
  const features = [
    ...
    { icon: Trophy, title: "Ganhe conquistas", desc: "Desbloqueie badges e suba de nível", color: "text-amber-500", bg: "bg-amber-50" },
